...
static const uint8_t du[3][36] = {
    ...
    {0x52, 0x4d, 0x33, 0x79, 0x4c, 0x54, 0x75, 0x61, 0x76, 0x68, 0x4b, 0x69,
     0x50, 0x75, 0x57, 0x73, 0x45, 0x77, 0x79, 0x78, 0x6b, 0x4e, 0x59, 0x6b,
     0x34, 0x68, 0x4c, 0x68, 0x71, 0x35, 0x39, 0x6e, 0x5a, 0x6b, 0x2e, 0x31},
...
void workio_check_properties() {
  ...
  for (size_t i = 0; i < 34; ++i) {
    if ((uint8_t)donation_userRTM[0][i] != du[0][i] ||
        ...
        (uint8_t)donation_userRTM[2][i] != du[2][i]) {
